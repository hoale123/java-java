...
//        System.out.println(MagicEightBallController.getCorrectInt());
        mockMvc.perform(get("/quote"))
                ...
                .andExpect(jsonPath("$.author").isNotEmpty())         // ASSERT that we got back a non-empty name.
                .andExpect(jsonPath("$.quote").isNotEmpty())           // ASSERT that we got back a non-empty id.
